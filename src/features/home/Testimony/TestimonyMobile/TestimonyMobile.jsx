...
const TestimonyMobile = ({ testimonials, sliderRef, beforeChange, afterChange }) => {
	return (
			...
			>
				{testimonials.map((testimonial) => (
					<div key={testimonial.id}>
						<div className='relative m-auto aspect-1/1 h-[247px] w-full max-w-[247px] overflow-hidden rounded-[1.25rem]'>
							<Image
						...
						<div className='mx-auto mt-[2.8125rem] w-full max-w-[19.125rem] text-center'>
							...
							<h3 className='mt-30 text-base font-semibold text-primary'>{testimonial.profile_name}</h3>
...
export default TestimonyMobile;
