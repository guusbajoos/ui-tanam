...
const FAQSolutionsContentItem = ({ content, index }) => {
	return (
		<div
		...
		>
			<div
				className={clsx('aspect-2/1 relative h-full w-full lg:h-[164px] lg:w-[264px]', {
...
export default FAQSolutionsContentItem;
